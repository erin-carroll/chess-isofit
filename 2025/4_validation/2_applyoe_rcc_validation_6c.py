...
# define file paths
base_dir =  '/store/carroll/col/data/2025/validation/'
...
rdn_factors_path = '/store/carroll/col/data/2025/rccs/rcc_snodgrass_mean_detrended_6c.txt'

working_dir = os.path.join(base_dir, f'{flight_id}_6c')
