...
fps = glob('/store/carroll/col/data/2025/raw/L1/radianceENVI/NEON_D13_UPTA_DP1_L034-1_20250712_rdn_*.hdr')
print(len(fps))
...
fp_out = '/store/carroll/col/data/2025/raw/L1/radianceENVI/NEON_D13_UPTA_DP1_L034-1_20250712_rdn.hdr'
