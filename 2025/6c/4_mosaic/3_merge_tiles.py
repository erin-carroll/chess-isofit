...
tile_fps = [x for x in glob(f'mosaic/{domain}_2025_mosaic_glt_cloudshadow_rounded_*.tif')]
print(len(tile_fps))
...
# input_tile_list = f'mosaic/file_lists/glt_tiles_list_{domain}.txt'
# tile_fps = [x.strip() for x in open(input_tile_list, 'r').readlines()]
...
#                  3), dtype=np.int32)
# output_file = f'mosaic/{domain}_reference_grid_cloudshadow.tif'
...
# ref_fp = f'mosaic/{domain}_reference_grid_cloudshadow.tif'
