ul_lr_list="/store/carroll/col/data/2025/mosaic/file_lists/ul_lr_grids_CRBU_cloudshadow_rerun_2.txt"
...
while read -r line; do
    ...
    mosaic_glt_out="/store/carroll/col/data/2025/mosaic/CRBU_2025_mosaic_glt_cloudshadow_${id}.tif"
    log_file="/home/carroll/logs/mosaic_glt_CRBU_2025_cloudshadow_${id}.log"
