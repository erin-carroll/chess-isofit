ul_lr_list="/store/carroll/col/data/2025/mosaic/file_lists/ul_lr_grids_CRBU_neon.txt"
...
while read -r line; do
    ...
    mosaic_glt_out="/store/carroll/col/data/2018/mosaic/glt_chunks/CRBU_2018_mosaic_glt_${id}.tif"
