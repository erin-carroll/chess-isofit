...
if '2025' in flight_id:
    raw_dir = '/store/carroll/col/data/2025/rccs/subsets/'
    loc_end = 'loc'
elif '2018' in flight_id:
    raw_dir = '/store/carroll/col/data/2018/rccs/cal_tarp/subset/'
    loc_end = 'igm'
...
if os.path.exists(working_dir) is False:
    apply_oe(
        ...
        input_loc = glob(os.path.join(raw_dir, f'{flight_id}_{loc_end}'))[0], # Location - IGM (lon, lat, elev)
