...
input_file_list = f'/store/carroll/col/data/2018/mosaic/file_lists/top_priority_isofit_obs.txt'
...
fp_out = f'/store/carroll/col/data/2018/mosaic/file_lists/ul_lr_grids_20260102.txt'
