...
apply_oe(
    ...
    input_loc = glob(f'{raw_dir}/*/{fid}_loc_smooth')[0], # Location - IGM (lon, lat, elev)
    input_obs = glob(f'{raw_dir}/*/{fid}_obs_smooth')[0], # Observations
    working_directory = working_dir,
    surface_path = surface_path,
    skyview_factor = f'2018/sky_view/sky_view_fid/{fid}_sky_view',
