...
mosaic_glt_out = '/store/carroll/col/data/2018/mosaic/CRBU_mosaic_glt_cloudshadow_rounded_2018.tif'

# all_rfl_files = '/store/carroll/col/data/2018/mosaic/file_lists/top_priority_isofit_rfl_pressureelevationtest.txt'
...
mosaic_rfl_out = f'/store/carroll/col/data/2018/mosaic/neon_2018_mosaic_rfl_6c_{band}'
...
# rfl (1 band)
cmd_str = f'python /store/carroll/repos/SpectralUtil/spectral_util/mosaic.py apply-glt {mosaic_glt_out} {all_rfl_files} {mosaic_rfl_out} --output_format envi --bands {band}'
print(cmd_str)
subprocess.run(cmd_str, shell=True)
