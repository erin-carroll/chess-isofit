...
working_dir = home+f'aspen/{flight_id}_sRTMnet/'
...
lut_config_path = os.path.join(home, 'lut_config_20250729.json')
...
apply_oe(
        ...
        presolve = False, # Attempts to solve for the right wv range (advisable only to use with small cubes or in concert with teh empirical_line setting, or a significant speed penalty will be incurred)
