...
for r in rs:
    ...
    apply_oe(
        ...
        input_loc = os.path.join(raw_dir, f'{flight_id}_rdn_ort_igm_ort_{r}'), # Location - IGM (lon, lat, elev)
        input_obs = os.path.join(raw_dir, f'{flight_id}_rdn_obs_ort_{r}'), # Observations
